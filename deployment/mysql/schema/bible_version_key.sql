...
(008,'ar_svd','SVD','arabe','Smith Van Dyke Arabic Version','','https://en.wikipedia.org/wiki/Bible_translations_into_Arabic','','Public Domain',''),
...
(012,'es_rvr','RVR', 'espanol','Reina Valeria','','https://en.wikipedia.org/wiki/Reina-Valera','','Public Domain',''),
...
(016,'fr_apee','APEE','français','Bible en Français','','https://fr.wikipedia.org/wiki/Traductions_de_la_Bible_en_fran%C3%A7ais','','Public Domain',''),
