...
--
-- Table structure for table `key_abbreviations`
--
DROP TABLE IF EXISTS `key_abbreviations`;
CREATE TABLE `key_abbreviations` (
...
INSERT INTO `key_abbreviations` (`id`, `a`, `b`, `p`) VALUES
(1, 'Gen', 1, 1),
(2, 'Ge', 1, 0),
(3, 'Gn', 1, 0),
(4, 'Exo', 2, 1),
